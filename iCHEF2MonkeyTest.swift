...
class iCHEF2MonkeyTest: XCTestCase {
    ...
    private func executeRandomGesture() {
        ...
        case 0:
            coordinate.tap()
            snapshot("Tap location on \(coordinate)")
            
        case 1:
            coordinate.doubleTap()
            snapshot("Double tap location on \(coordinate)")
        ...
        case 2:
            ...
            snapshot("Scroll up from \(coordinate) to \(vector)")
            coordinate.tap()
        ...
        case 3:
            ...
            let vector = CGVector(dx: coordinate.screenPoint.x / maxSize.width, dy: dy)
            scroll(fromCoordinate: coordinate, toCoordinate: getCoordinateForVector(vector: vector))
            snapshot("Scroll down from \(coordinate) to \(vector)")
            coordinate.tap()
        ...
        case 4:
            ...
            scroll(fromCoordinate: coordinate, toCoordinate: getCoordinateForVector(vector: vector))
            snapshot("Scroll left from \(coordinate) to \(vector)")
            coordinate.tap()
        ...
        case 5:
            ...
            let vector = CGVector(dx: dx, dy: coordinate.screenPoint.y / maxSize.height)
            scroll(fromCoordinate: coordinate, toCoordinate: getCoordinateForVector(vector: vector))
            snapshot("Scroll right from \(coordinate) to \(vector)")
            coordinate.tap()
        ...
        case 7:
            ...
            snapshot("Orientation -> PortraitUpsideDown")
            coordinate.tap()
            
        case 8:
            device.orientation = .landscapeLeft
            snapshot("Orientation -> LandscapeLeft")
            coordinate.tap()
            
        case 9:
            device.orientation = .landscapeRight
            snapshot("Orientation -> LandscapeRight")
            coordinate.tap()
      ...
      //      device.orientation = .faceDown
        ...
        case 10:
            ...
            snapshot("Scroll random direction")
            coordinate.tap()
